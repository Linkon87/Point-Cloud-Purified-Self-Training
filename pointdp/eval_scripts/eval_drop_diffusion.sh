...
CUDA_VISIBLE_DEVICES=2 python main.py --entry attack --model-path ./runs/${model}_cls_ae_diffusion_step_1/model_best_test.pth --exp-config ./configs/attack/drop/${model}_truncate_diffusion_pgd_drop.yaml > ./output/${model}/drop_diffusion_feature.txt
