...
from  test_protocal import  mix_attack
# ----------------------------------
def main():
    ...
    parser.add_argument('--test_data', type=str,
                        default='make_data/curvenet/adaptive/curvenet_diffusion_nattack_linf_1_recons.npy')
    parser.add_argument('--test_label', type=str,
                        default='make_data/curvenet/adaptive/curvenet_diffusion_nattack_linf_1_ground.npy')

    parser.add_argument('--backbone', default='curvenet', type=str,choices=['dgcnn','pointnet','pointnet2','pct','pointmlp','curvenet'])
    ...
    for te_batch_idx, (te_inputs, te_labels) in enumerate(te_dataloader):
        ...
        with torch.no_grad():
            ...
            print('real time clean acc : {:.2f}'.format(torch.cat(correct_clean).numpy().mean() * 100))
            ...
            print('siadv_or_knn : {:.2f}'.format(torch.cat(correct_knn_or_siadv).numpy().mean() * 100))
