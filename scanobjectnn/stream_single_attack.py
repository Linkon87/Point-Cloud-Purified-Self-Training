...
def main():
    ...
    parser.add_argument('--test_data', type=str,
                        default='scanobjectnn/make_data/curve/adaptive/3new/clean_auto_recons.npy')
    parser.add_argument('--test_label', type=str,
                        default='scanobjectnn/make_data/curve/adaptive/3new/label.npy')

    parser.add_argument('--backbone', default='curvenet', type=str,choices=['pointnet2','pct','curvenet'])
    ...
    for te_batch_idx, (te_inputs, te_labels) in enumerate(te_dataloader):
        ...
        with torch.no_grad():
            ...
            print('real time adv acc: {:.2f}'.format(torch.cat(correct_adv).numpy().mean() * 100))
